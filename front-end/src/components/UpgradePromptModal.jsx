  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-xl w-11/12 max-w-md p-6 space-y-4 text-center dark:bg-[#4F5962]">
        <h2 className="text-2xl font-bold text-[#4F5962] dark:text-white">Upgrade to Pro</h2>
        <p className="text-[#4F5962] dark:text-white text-base">
          You’ve hit the free-tier limit. Pro unlocks:
        </p>
        <ul className="text-left text-[#4F5962] dark:text-white text-sm pl-4 list-disc space-y-1">
          <li>Unlimited task lists</li>
          <li>Unlimited tasks per list</li>
          <li>AI-powered task breakdown</li>
        </ul>
        <p className="font-semibold text-[#4C6CA8] dark:text-[#90A9D6]">Just $5/month or $30/year</p>
